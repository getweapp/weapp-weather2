...
function getCityName(latitude, longitude, callback) {
    ...
    var apiURL = "https://api.getweapp.com/vendor/baidumap/geocoder?lat="+ latitude + "&lng=" + longitude;
...
function getWeatherByLocation(latitude, longitude, callback) {
    ...
    var apiURL = "https://api.getweapp.com/vendor/darksky/forecast?lat=" + latitude + "&lng=" + longitude;
